...
MD_batch_rin script run on each dir by job_batchrin. did probe and arpeggio for each active site

probe-violins.py creates violin plots of contact counts for each FG in each of the three active sites

analyze.in is another cpptraj input file for getting rmsds, rms fluctuations etc
