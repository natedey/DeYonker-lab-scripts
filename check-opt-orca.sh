...
egrep 'GEOMETRY OPTIMIZATION CYCLE |    Energy change | RMS gradient | MAX gradient | RMS step | MAX step |FINAL SINGLE POINT ENERGY |FINAL ENERGY EVALUATION AT THE STATIONARY POINT' $file | grep -B 3 -A 3 "RMS gradient * $lowrmsforce"
echo ""
echo "based on smallest max gradient:"
egrep 'GEOMETRY OPTIMIZATION CYCLE |    Energy change | RMS gradient | MAX gradient | RMS step | MAX step |FINAL SINGLE POINT ENERGY |FINAL ENERGY EVALUATION AT THE STATIONARY POINT' $file | grep -B 4 -A 2 "MAX gradient * $lowmaxforce"
echo ""
echo "based on lowest energy:"
egrep 'GEOMETRY OPTIMIZATION CYCLE |    Energy change | RMS gradient | MAX gradient | RMS step | MAX step |FINAL SINGLE POINT ENERGY |FINAL ENERGY EVALUATION AT THE STATIONARY POINT' $file | grep -B 1 -A 5 "FINAL SINGLE POINT ENERGY * $lowenergy"
#echo ""
#echo "final cycle:"
