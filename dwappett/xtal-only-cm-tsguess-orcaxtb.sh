...
# xtal-only-cm-tsguess-orcaxtb.sh {model pdb}
# DAW script for setting up constrained ts optimization with xtb in orca
# this version for xtal models

# generate tsguess.pdb
xtal_compatible_old_align_TSA_and_replace.py -modpdb $1
# create input file
...
bond1a=$(( $(awk '$4 == "TSA" && $3 == "C1" {print $2}' tsguess.pdb) - 1 ))
bond1b=$(( $(awk '$4 == "TSA" && $3 == "C9" {print $2}' tsguess.pdb) - 1 ))
bond2a=$(( $(awk '$4 == "TSA" && $3 == "C5" {print $2}' tsguess.pdb) - 1 ))
bond2b=$(( $(awk '$4 == "TSA" && $3 == "O7" {print $2}' tsguess.pdb) - 1 ))
