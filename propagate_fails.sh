...
if [ -z "$1" ]; then
echo "You must give an argument for the file renaming!"
exit
fi

if [ "$1" == "--help" ]; then
echo "This script takes an {arg1} and copies your input (1.inp), output (1.out), a Gaussian script file, and checkpoint file (1.chk) 
